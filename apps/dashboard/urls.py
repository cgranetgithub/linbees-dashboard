...
urlpatterns = patterns('',
    ...
    url(r'^task/comparison/', views.task.comparison, name='task_comparison'),
    url(r'^task/table/' , views.task.comparison_table, name='task_table'),
    ...
    url(r'^data/total_time_per_project/', queries.total_time_per_project, name='time_repartition_query'),
    url(r'^data/total_cost_per_project/', queries.total_cost_per_project, name='cost_repartition_query'),
    )
